...
const education = [
  {
    ...
    year: '2022 - 2026',
    achievements: ['Shortlisted for SSB through TES-48', '3 NPTEL certified courses', '3 Indian Army scholarships']
  },
  {
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {experiences.map((exp, index) => (
                <div key={exp.id} className="relative flex items-start" style={{ animationDelay: `${index * 200}ms` }}>
                  {/* Timeline dot */}
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {education.map((edu, index) => (
              <Card key={index} className="glass glow-card hover-lift" style={{ animationDelay: `${index * 150}ms` }}>
                <CardContent className="p-6">
                  ...
                  {edu.achievements && (
                    <div className="mt-3">
                      <p className="text-sm font-medium text-secondary mb-1">Achievements:</p>
